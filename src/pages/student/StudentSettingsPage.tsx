    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-sky-400 focus:outline-none disabled:bg-gray-50 disabled:text-gray-400"
        />
      </div>
    </div>
  );
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-sky-600 uppercase font-semibold">Student</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSaveProfile} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <InputField label="Roll Number" name="roll_number" value={profileForm.roll_number} onChange={handleProfileChange} icon={Hash} />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <InputField label="Branch / Department" name="branch" value={profileForm.branch} onChange={handleProfileChange} icon={BookOpen} />
                <InputField label="College Name" name="college" value={profileForm.college} onChange={handleProfileChange} icon={Building} />
              </div>

              <button
                type="submit"
                disabled={savingProfile}
                className="w-full flex items-center justify-center gap-2 py-2.5 bg-sky-500 text-white rounded-lg hover:bg-sky-600 transition-colors text-sm font-semibold disabled:opacity-50"
              >
                {savingProfile ? (
                ...
                <div key={name}>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-10 pr-10 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-sky-400 focus:outline-none"
                    />
                    <button
                      type="button"
